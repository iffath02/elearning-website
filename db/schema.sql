...
INSERT INTO courses (category, course_name, image_url) VALUES ('big data', 'hadoop', 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Hadoop_logo.svg/1280px-Hadoop_logo.svg.png');
...
INSERT INTO course (category, course_id, course_name, image_url, blurb, curriculum, skills_covered) VALUES ('big data', 6, 'hadoop', 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Hadoop_logo.svg/1280px-Hadoop_logo.svg.png', 'hadoop Certification Training will train you to build efficient React applications by mastering the concepts', 'Intro, Components and styling, Handling navigation', 'components, hadoop, hadoop');